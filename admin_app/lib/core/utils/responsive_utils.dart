...
/// Vertical card list that becomes 2–3 columns on larger breakpoints.
class ResponsiveCardList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final rowCount = itemCount == 0 ? 0 : ((itemCount + columns - 1) ~/ columns);
    return ListView.separated(
      controller: controller,
      padding: padding,
      physics: physics,
          ...
          child: Row(
            ...
            children: [
              for (var c = 0; c < columns; c++) ...[
                ...
                Expanded(
                  child: rowIndex * columns + c < itemCount
                      ? itemBuilder(context, rowIndex * columns + c)
...
/// Sliver variant of [ResponsiveCardList] for CustomScrollView bodies.
