...
class LabApplicationSubmittedScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<LabApplicationSubmittedScreen> createState() =>
      _LabApplicationSubmittedScreenState();
}

class _LabApplicationSubmittedScreenState
    extends ConsumerState<LabApplicationSubmittedScreen> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Lab application status'),
        leading: IconButton(
