        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    isVerified
                        ? 'Patients can book you in the 1mg Care user app'
                        : isRejected
                            ? 'Contact support if you need more information'
                            : 'Sent to admin for review · usually 24–48 hrs',
            ...
            const OfferPromoCard(
              ...
              subtitle:
                  'Track progress below — like order tracking on PharmEasy',
              badge: 'TRACK',
            ...
            if (isVerified)
              Column(
                children: [
                  const OfferPromoCard(
                    title: 'You\'re on the user app',
                    subtitle: 'Run 1mg Care (main app) to see your live listing',
                    badge: 'LIVE',
