class TrackingSnapshot {
  ...
  bool get isNurse => providerType == 'nurse';
  ...
  String get statusLabel {
    switch (trackingStatus) {
      case 'on_the_way':
        return isNurse ? 'Nurse is on the way' : 'Doctor is on the way';
      case 'arrived':
        return isNurse ? 'Nurse has arrived' : 'Doctor has arrived';
      case 'in_service':
      ...
      case 'accepted':
        return isNurse
            ? 'Nurse accepted — waiting to start the trip'
            : 'Doctor accepted — waiting to start the trip';
      default:
