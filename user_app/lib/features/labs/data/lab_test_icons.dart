...
extension LabTestCategoryX on LabTestCategory {
  Color get iconColor {
    return switch (this) {
      ...
      LabTestCategory.coagulationTests => const Color(0xFFC62828),
      LabTestCategory.urineTests => const Color(0xFF1E88E5),
      LabTestCategory.stoolTests => const Color(0xFF795548),
      ...
      LabTestCategory.cardiacTests => const Color(0xFFE53935),
      LabTestCategory.vitaminTests => const Color(0xFFF59E0B),
      LabTestCategory.hormoneTests => const Color(0xFF5E35B1),
      LabTestCategory.pregnancyTests => const Color(0xFFDB2777),
      LabTestCategory.cancerMarkerTests => const Color(0xFF7C3AED),
      LabTestCategory.serologyTests => const Color(0xFF00897B),
      LabTestCategory.microbiologyTests => const Color(0xFF2E7D32),
      LabTestCategory.cytopathologyTests => const Color(0xFF5D4037),
