...
function toVehicle(v) {
  ...
  return {
    ...
    baseFare: v.baseFare != null ? Number(v.baseFare) : null,
    perKm: v.perKm != null ? Number(v.perKm) : null,
    minFare: v.minFare != null ? Number(v.minFare) : null,
...
function toAmbulance(doc, { includeFleetSecrets = false } = {}) {
  ...
  return {
    ...
    baseFare: d.baseFare != null ? Number(d.baseFare) : 400,
    perKm: d.perKm != null ? Number(d.perKm) : 20,
    minFare: d.minFare != null ? Number(d.minFare) : 0,
